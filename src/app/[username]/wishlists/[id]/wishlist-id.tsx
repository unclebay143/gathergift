...
import { OutRightContributionModal } from "@/components/ContributionModal";
...
export function SingleWishlistPage({
  currentUser,
  wishlist,
  username,
}: {
    ...
    <PublicLayout>
      <div className='relative overflow-hidden' id='top'>
        <div className='min-h-screen px-4 bg-gradient-to-b from-red-50 to-green-50 text-gray-800'>
          <div
            className={cn(
              "max-w-4xl mx-auto py-8 space-y-12",
              !hasItems && "space-y-5"
            )}
          >
            ...
            <section className='bg-white rounded-lg shadow-md p-6 space-y-4 max-w-4xl mx-auto'>
              ...
              <div className='flex items-center justify-center'>
                <button
                  onClick={() => {
                    setIsOutRightContributionModalOpen(true);
                  }}
            ...
            <section className='space-y-4 max-w-4xl mx-auto'>
              ...
              <div className='flex items-center justify-center space-x-2 bg-white rounded-lg shadow-md p-2'>
                <input
                  ...
                  type='text'
                  defaultValue={`https://gathergift.vercel.app/${username}/wishlists/${_id}`}
                />
                <button
                  onClick={() => {
                    navigator.clipboard.writeText(
                      `https://gathergift.vercel.app/${username}/wishlists/${_id}`
                    );
      ...
      <OutRightContributionModal
        isOpen={isOutRightContributionModalOpen}
        onClose={() => setIsOutRightContributionModalOpen(false)}
        currency={currency}
